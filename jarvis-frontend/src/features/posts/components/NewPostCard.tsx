...
const NewPostCard = () => {
  ...
  return (
    <Card
      className="flex items-center justify-center w-[450px] h-full bg-neutral-300 dark:bg-neutral-800 text-white border-none rounded-lg cursor-pointer hover:bg-neutral-400 dark:hover:bg-neutral-700 transition-colors"

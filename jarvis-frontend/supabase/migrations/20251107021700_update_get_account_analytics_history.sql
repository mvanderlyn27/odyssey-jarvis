...
BEGIN
    ...
    RETURN QUERY EXECUTE format(
        'SELECT
            ...
            MAX(follower_count) as total_followers,
            MAX(likes_count) as total_likes,
            MAX(total_post_comments) as total_comments,
            MAX(total_post_shares) as total_shares,
            MAX(total_post_views) as total_views
        FROM %I
